...
var defaults = {
    ...
    tooltipRandom: 'В случайном порядке', // String; Text of tooltip which will be displayed next to icon for random slideshow toggling.; ; [ 'Random', 'Kolejność losowa' ]
    ...
    tooltipZoom: 'Увеличение', // String; Text of tooltip which will be displayed next to icon for zoom photo.; ; [ 'Zoom', 'Powiększenie' ]
