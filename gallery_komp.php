...
-->
	   ...
	   function pageclass(value){
		 ...
		 document.getElementById('formsend2').sort.value = value;
    ...
    <body>
        ...
        <button class="btn btn-default" type="button">Поиск</button>
                    ...
                    <P><a href="gallery_3.php?category=1">Подготовительное отделение</a></P>
                    <P><a href="gallery_3.php?category=2">Керамика</a></P>
                    <P><a href="gallery_3.php?category=3">Компьютерная графика</a></P>
                    <P><a href="gallery_3.php?category=4">Живопись</a></P>
                    <P><a href="gallery_3.php?category=5">Архитектурный дизайн</a></P>
                    <hr>
      ...
      -->
                ...
                <div class="col-sm-10 text-left">
                    <div class="container">
						<p><h1 class="text-center">Работы по композициям</h1></p>
                                <?php
...
if ($cat == "1") $catname = "Подготовительное отеление";
					if ($cat == '2') $catname = "Керамика";
					if ($cat == '3') $catname = "Компьютерная графика";
					if ($cat == '4') $catname = "Живопись";
					else $catname = "Архитектурный дизайн";

	
$q="SELECT * FROM gallery WHERE class='0' ORDER BY id DESC ";
...
while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
   // echo "\n".$row["img"]."\n";
    ...
    echo " <a href='http://biba.esy.es/kamathebullet/uploads/". $kek . "'". "><img src='http://biba.esy.es/kamathebullet/uploads/" . $kek . "'". " alt='"."\"" .$name. "\"" .", ". $year . ". Автор работы: " .$author . ", " .$age . " лет. Преподаватель: " .$teacher . ".' /></a> ";
