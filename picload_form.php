    ...
    <body>
      ...
      -->
                ...
                <div class="col-sm-8 text-left">
                    <form enctype="multipart/form-data" action="upload.php" method="post" name="DownloadPic" >
                        <!-- загрузка файла -->
                        <table style="border-spacing: 0px 5px;">
                           <script>
                            ...
                            <tr>
                                ...
                                <td>
                                  <!-- <div class="input-group">    старый файл
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        Обзор&hellip; <input name="userfile" type="file" style="display: none;" multiple>
                    </span>
                </label>
...
<input id="input-1" type="file" class="file" name="userfile">
                                    ...
                                    <script>
var target = document.getElementById("input-1");
    ...
    var i = 0,
     ...
     len = files.length;
                           ...
                           <tr>
                                ...
                                <td>
                                   <script>
									   document.write('<input type="text" name="Year" class="form-control" aria-describedby="basic-addon2" value="');
									    var date = new Date();
                            ...
                            <script language="javascript" type="text/javascript">
									   var date = new Date();
									   var FullYear = date.getFullYear();
                                       document.DownloadPic.Year.value.write(FullYear); 
                                           </script>
                            <tr>
                                    <td>Категория:</td>
                            ...
                            <tr>
                                <td>Возраст:</td>
                                <td>
                                    <input type="text" name="Age" class="form-control" placeholder="Возраст" aria-describedby="basic-addon2" required> </td>
                            </tr>
                            <tr>
                                <td>Преподаватель:</td>
                                <td>
                                    <input type="text" name="Teacher" class="form-control" placeholder="Преподаватель" aria-describedby="basic-addon2" required> </td>
                            </tr>
                            <tr>
                                <td>Класс:</td>
                                <td>
